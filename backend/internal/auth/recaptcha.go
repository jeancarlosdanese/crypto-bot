...
func VerifyRecaptcha(token string) (bool, error) {
	...
	logger.Debug("Resposta do reCAPTCHA", "body", string(body))
	...
	if !recaptchaResponse.Success {
		logger.Debug("Erro na verificação do reCAPTCHA", "error", recaptchaResponse.ErrorCodes)
	}
